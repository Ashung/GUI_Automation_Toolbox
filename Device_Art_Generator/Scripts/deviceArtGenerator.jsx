...
Add codes at the end of this documents, like: 
...
{id: 'iPad2_black', title: 'iPad 2', landOffset: [0,0], portOffset: [223,373], screenSize: [768,1024], landDoc: [0,0], portDoc: [1209,1784]},
{id: 'iPad2_white', title: 'iPad 2', landOffset: [0,0], portOffset: [223,373], screenSize: [768,1024], landDoc: [0,0], portDoc: [1209,1784]},
{id: 'iPhone4s_black', title: 'iPhone 4s', landOffset: [0,0], portOffset: [202,363], screenSize: [640,960], landDoc: [0,0], portDoc: [1044,1904]},
{id: 'iPhone4s_white', title: 'iPhone 4s', landOffset: [0,0], portOffset: [202,363], screenSize: [640,960], landDoc: [0,0], portDoc: [1044,1904]},
{id: 'iPhone5_black', title: 'iPhone 5', landOffset: [0,0], portOffset: [198,336], screenSize: [640,1136], landDoc: [0,0], portDoc: [1038,1900]},
{id: 'iPhone5_white', title: 'iPhone 5', landOffset: [0,0], portOffset: [198,336], screenSize: [640,1136], landDoc: [0,0], portDoc: [1038,1900]},
{id: 'iPadMini_black', title: 'iPad Mini', landOffset: [0,0], portOffset: [248,181], screenSize: [768,1024], landDoc: [0,0], portDoc: [1264,1600]},
{id: 'iPadMini_white', title: 'iPad Mini', landOffset: [0,0], portOffset: [248,181], screenSize: [768,1024], landDoc: [0,0], portDoc: [1209,1600]}
...
function createDeviceArt(deviceId, isPortrait, transparentBackground, hasShadow, hasLight) {
    ...
    if(!arguments[1]) { isPortrait = true; }
    if(!arguments[2]) { transparentBackground = true; }
    if(!arguments[3]) { hasShadow = true; }
    if(!arguments[4]) { hasLight = true; }
    for(var i = 0; i < devices.length; i ++) {
        if(devices[i].id == deviceId) {
            ...
            shadowImage = isPortrait ? portShadowImage : landShadowImage;
            landDeviceImage = devicePath + '/land_back.png';
            portDeviceImage = devicePath + '/port_back.png';
            deviceImage = isPortrait ? portDeviceImage : landDeviceImage;
            landLightImage = devicePath + '/land_fore.png';
            portLightImage = devicePath + '/port_fore.png';
            lightImage = isPortrait ? portLightImage : landLightImage;
            break;
        }
    }
